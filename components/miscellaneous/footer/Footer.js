                ...
                <div className="main-footer-content">
                    ...
                    <div className="f-section f-service">
                        ...
                        <ul className='list-unstyled'>
                            <li>
                                <Link href={`http://weddingbanquets.in/banquet-halls/${selectedCity}/all`} className='f-link'>Wedding venues</Link>
                            </li>
                            <li>
                                <Link href={`http://weddingbanquets.in/top-makeup-artists//${selectedCity}/all`} className='f-link'>Photographer</Link>
                            </li>
                            <li>
                                <Link href={`/`} className='f-link'>Makeup Artist</Link>
                            </li>

                            <li>
                                <Link href={`http://weddingbanquets.in/best-mehndi-artists/${selectedCity}/all`} className='f-link'>Mehndi Artist</Link>
                            </li>

                            <li>
                                <Link href={`http://weddingbanquets.in/band-baja-ghodiwala/${selectedCity}/all`} className='f-link'>Band baja</Link>
                            </li>
                    ...
                    <div className="f-section f-quick-links">
                        ...
                        <ul className='list-unstyled'>
                            ...
                            <li>
                                <Link className='f-link' href="http://weddingbanquets.in/career"> Career  </Link>
                            </li>
                            <li>
