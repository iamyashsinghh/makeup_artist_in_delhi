...
function Venue(props) {
  ...
  //       "@type": "ListItem",
  //       "position": 1,
  //       "item": { "@id": "https://bestmakeupartistindelhi.com", "name": "Wedding Banquets" }
  //     },
  //     {
  //       "@type": "ListItem",
  //       "position": 2,
  //       "item": {
  //         "@id": `https://bestmakeupartistindelhi.com/${props.category}`,
  ...
  //       "position": 3,
  //       "item": {
  //         "@id": `https://bestmakeupartistindelhi.com/${props.city}`,
  ...
  //       "position": 4,
  //       "item": {
  //         "@id": `https://bestmakeupartistindelhi.com/${props.locality}`,
